...
namespace LLaser.Component
{
    ...
    public class BmpMaker : BmpMakerBase
    {
        ...
        public BmpMaker()
        {
            ...
            _bmpExecutors.Add(Size);
            _bmpExecutors.Add(Color);
            _bmpExecutors.Add(ImportBmp);
            _bmpExecutors.Add(Gradation);
            _bmpExecutors.Add(Window);
            ...
            foreach (var bmpMakerBase in _bmpExecutors)
            {
        ...
        private readonly List<BmpMakerBase> _bmpExecutors = new List<BmpMakerBase>();
        ...
        public SizeModel Size
        {
            ...
            set { SetBmpProperty(ref _sizeModel, value); }
        }

        public ColorModel Color
        {
            get { return _colorModel; }
            set { SetBmpProperty(ref _colorModel, value); }
        }

        public GradationModel Gradation
        {
            get { return _gradationModel; }
            set { SetBmpProperty(ref _gradationModel, value); }
        }

        public ImportBMPModel ImportBmp
        {
            get { return _importBmpModel; }
            set { SetBmpProperty(ref _importBmpModel, value); }
        }

        public WindowModel Window
        {
            get { return _windowModel; }
            set { SetBmpProperty(ref _windowModel, value); }
        }
        ...
        private void WorkerDoWork(object sender, DoWorkEventArgs e)
        {
            ...
            foreach (var executor in _bmpExecutors)
            {
